                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li class="dropdown-item"><i class="fa fa-user-circle text-primary mr-2"></i>
                                    مشاهده پروفایل</li>
                                <li class="dropdown-item"><i class="fa fa-users text-primary mr-2"></i> اضافه
                                    کردن به
                                    دوستان نزدیک</li>
                                <li class="dropdown-item"><i class="fa fa-plus text-primary mr-2"></i> اضافه
                                    کردن به گروه</li>
                                <li class="dropdown-item"><i class="fa fa-ban text-primary mr-2"></i> م</li>
                            </ul>
                        </div>
                    </div>

    ...
    <div class="fixed-content-body dz-scroll" id="DZ_W_Fixed_Contant">
                ...
                <ul class="metismenu tab-nav-menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('categories.index')}}">مدیریت دسته بندی</a></li>
                            <li><a href="{{route('tags.index')}}">مدیریت تگ</a></li>
                            <li><a href="#">مدیریت پست ها</a>
                                <ul aria-expanded="false">
                                    <li><a href="{{route('posts.show')}}">نمایش پست</a></li>
        ...
        <div class="tab-pane chart-sidebar fade show active" role="tabpanel">
                ...
                <div class="card-body">
                    <div class="chart-point">
                        ...
                        <ul class="chart-point-list">
                            ...
                            <li><i class="fa fa-circle text-success ml-1"></i> 35% رویداد</li>
                            <li><i class="fa fa-circle text-warning ml-1"></i> 25% سایر</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="card bg-info-light">
                ...
                <div class="card-body">
                    <p class="mb-2 d-flex"><img width="22" height="22" src="images/icon1.png" class="ml-2"
                                                alt>فتوشاپ
                    ...
                    <p class="mb-2 d-flex"><img width="22" height="22" src="images/icon2.png" class="ml-2"
                                                alt>ویرایشگر کد
